...
export const editableRootStyle = {
  ...
  '--slot4-panel-bg': '#eef4fb',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#526172',
  '--slot4-soft-muted-text': '#6b7685',
  '--slot4-accent': '#2563eb',
  '--slot4-accent-fill': '#2563eb',
  '--slot4-accent-soft': '#e8f1ff',
  '--slot4-dark-bg': '#071527',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dde8f3',
  '--slot4-cream': '#f8fbff',
  '--slot4-warm': '#f4f7fb',
...
export const editableDesignContract = {
  ...
  button: {
    primary: `inline-flex items-center justify-center rounded-full ${editablePalette.accentBg} px-7 py-3 text-sm font-black text-white shadow-sm transition hover:opacity-90`,
